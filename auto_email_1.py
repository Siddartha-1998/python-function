...
def send_mail(file_path, _from='sgarigipati@techforce.ai', to_emails=[], subject='Test || Mail', 
    ...
    with smtplib.SMTP('smtp.office365.com', 587) as smtp:
        ...
        smtp.login(_from, 'Siddu1998@')
        smtp.send_message(msg)


send_mail(file_path=r'C:\Users\Techforce\OneDrive - Digitamize Inc\Testing the mario chat bot for time_lapse.xlsx',
         to_emails=['sgarigipati@techforce.ai', 'smakkena@techforce.ai'], body_type='Html')
